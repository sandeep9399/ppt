...
📝 Prompt for AI Image: India health map with disease icons and shaded regions in Apollo colors'''
            ...
            layout_box = new_slide.shapes.add_textbox(Inches(0.5), Inches(5.8), Inches(6.5), Inches(1.0))
...
Prompt: {row['Prompt']}'''
            ...
            try:
                import openai
                openai.api_key = "sk-your-real-key-here"  # Replace with your actual OpenAI API key  # Replace or set as secret in Streamlit
                ...
                if img_response.status_code == 200:
                    ...
                    new_slide.shapes.add_picture(img_data, Inches(6.0), Inches(1.8), width=Inches(3.0))
            except:
